...
function controlDoor(angle) {
  db.ref("/board1/outputs/digital/15").set(angle)
    .then(() => console.log(`Servo actualizado a ${angle} grados`))
    .catch(error => console.error("Error al actualizar servo:", error));
}
